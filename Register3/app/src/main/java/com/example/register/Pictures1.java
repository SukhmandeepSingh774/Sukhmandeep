...
public class Pictures1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pictures1);
        ...
        img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                img1.setImageDrawable(getResources().getDrawable(R.drawable.layer9));
        ...
        img2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                img2.setImageDrawable(getResources().getDrawable(R.drawable.layer1));
                count=count+1;
        ...
        img3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                img3.setImageDrawable(getResources().getDrawable(R.drawable.layer2));
                count=count+1;
        ...
        img4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                img4.setImageDrawable(getResources().getDrawable(R.drawable.layer3));
                count=count+1;
        ...
        img9.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                img9.setImageDrawable(getResources().getDrawable(R.drawable.layer4));
                count=count+1;
        ...
        loadpics.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                count=0;
                Intent intent1=new Intent(Pictures1.this,Pictures.class);
                intent1.putExtra("name", name);
                intent1.putExtra("email", email);
                intent1.putExtra("phone", phone);
                startActivity(intent1);
                Toast.makeText(Pictures1.this, "Pictures has been Reloaded", Toast.LENGTH_SHORT).show();
            ...
            public void onClick(View v) {
                if(count==4) {
                    if (checkBox.isChecked())
                    {
                        ...
                        if (newRowId > 0) {
                            Toast.makeText(Pictures1.this, "Data is saved in database", Toast.LENGTH_LONG).show();
                        }
                        db.close();
                      //  Toast.makeText(Pictures1.this, "name is "+name, Toast.LENGTH_SHORT).show();
                        ...
                        AlertDialog.Builder alert = new AlertDialog.Builder(Pictures1.this);
                        alert.setTitle("Verified");
                        alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface arg0, int arg1) {
                                Intent intent = new Intent(Pictures1.this, MainActivity.class);
                ...
                else
                {
                    ...
                    alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface arg0, int arg1) {
                            Intent intent = new Intent(Pictures1.this, Pictures1.class);
                            startActivity(intent);
                        }});
                    alert.show();
